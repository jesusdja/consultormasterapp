...
import 'package:consultormasterapp/pages/home/menu/create_register/widgets/register_document_send_data.dart';
            ...
            builder: (context, provider, child){
              ...
              return Scaffold(
                body: Container(
                  ...
                  (provider.captureFinish ? ( provider.captureFinishContinue ? const RegisterDocumentSendData() : bodyFinish()) : body()),
                ),
              );
            }
        )
